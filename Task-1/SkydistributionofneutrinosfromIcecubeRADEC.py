#PROGRAM TO PLOT THE SKY DISTRIBUTION OF NEUTRINO EVENTS RECORDED BY ICE CUBE BETWEEM 2008-18 IN ICRS: RA, DEC coordinates
import pandas as pd
import numpy as np
...
#    plot_tissot_ellipse(circ_long[:, None], circ_lat, radius, ax=ax, fc='k', alpha=0.3, linewidth=0)
        ...
        plt.suptitle(filenamewithpath.replace('icecube_10year_ps/events/','') + 'RA,DEC')
    plt.show()
