...
if 'ATNF.csv' not in os.listdir(os.getcwd() + '/data/'):
    ...
    r = requests.get('https://www.atnf.csiro.au/research/pulsar/psrcat/proc_form.php?version=1.70&Name=Name&RaJD=RaJD&DecJD=DecJD&P0=P0&Dist=Dist&Dist_DM=Dist_DM&startUserDefined=true&c1_val=&c2_val=&c3_val=&c4_val=&sort_attr=jname&sort_order=asc&condition=&pulsar_names=&ephemeris=short&coords_unit=raj%2Fdecj&radius=&coords_1=&coords_2=&style=Long+csv+with+errors&no_value=&fsize=3&x_axis=&x_scale=linear&y_axis=&y_scale=linear&state=query&table_bottom.x=43&table_bottom.y=27')
    ...
    dat2 = dat['NAME;RAJD;DECJD;P0;DIST;DIST_DM'.split(';')]
